...
/**
 * estimator_aid_source3d.h — plain C struct stub required for standalone EKF2 build.
 *
 * PX4's ekf.h hardcodes `#include <uORB/topics/estimator_aid_source3d.h>`, so this
 ...
 *
 * Generated from msg/EstimatorAidSource3d.msg (PX4-Autopilot main).
 */
#pragma once
#include <stdint.h>
#include <stdbool.h>
